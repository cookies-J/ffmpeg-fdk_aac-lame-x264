...
#--disable-avdevice --disable-indevs \
#--disable-outdevs --disable-debug \
...
if [ "$FDK_AAC" ]
then
	CONFIGURE_FLAGS="$CONFIGURE_FLAGS --enable-libfdk-aac --enable-nonfree --enable-encoder=libfdk_aac"
fi
